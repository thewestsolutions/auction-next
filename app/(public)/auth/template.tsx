    ...
    <div className="relative container grid h-screen flex-col items-center justify-center lg:max-w-none lg:grid-cols-2 lg:px-0">
      <div className="bg-muted relative hidden h-full flex-col p-10 text-white lg:flex dark:border-r">
        ...
        <div className="relative z-20 flex items-center gap-4 text-lg font-medium">
          <Image src="https://placehold.co/40x40.png" alt="logo" width={40} height={40} />
          Auction Platform
        </div>
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg">
              &ldquo;This platform has revolutionized how we handle auctions, making it more
              efficient and transparent than ever before.&rdquo;
            </p>
